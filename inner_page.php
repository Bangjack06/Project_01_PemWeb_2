        ...
        <div class="container"><a class="navbar-brand" href="index.html"></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="pasien">Pasien</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="dokter">Dokter</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="periksa">Periksa</a></li>
            </ul><a class="btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4" href="landing_page.php">Logout</a>
          </div>
        </div>
      </nav>
        ...
        <div class="container">
          <div class="row min-vh-xl-100 min-vh-xxl-25">
            ...
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-6">
              <h1 class="fw-light font-base fs-6 fs-xxl-7">Kami <strong>peduli </strong>dengan <strong>Kesehatanmu</strong></h1>
              <p class="fs-1 mb-5">Peroleh perawatan yang Anda butuhkan kapan saja, di mana saja, baik secara online atau tatap muka.<br />Dengan tim dokter spesialis kami, Anda dapat memulai perjalanan menuju kehidupan yang lebih baik.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="container">
            <div class="row justify-content-md-between justify-content-evenly py-4">
              <div class="col-12 col-sm-8 col-md-6 col-lg-auto text-center text-md-start">
                <p class="fs--1 my-2 fw-bold text-200">All rights Reserved &copy; Bangjack, 2024</p>
              </div>
