      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#departments">Departments</a></li>
              ...
              <li class="nav-item px-2"><a class="nav-link" href="#testimoni">Testimony</a></li>
